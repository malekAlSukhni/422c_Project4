...
public abstract class Critter {
	 ...
	 * 
	 * @param direction
	 *            is a number between 0-7 direction indicates which way the
	 *            critters will move check each case and adjust coordinates
	 *            accordingly adds them to a list saying they have moved
	 ...
	 *            is a number between 0-7 direction indicates which way the
	 *            critters will move check each case and adjust coordinates
	 *            accordingly adds them to a list indicating they have moved
	 *            this time step
	 */
	...
	/**
	 * checks if parent Critter can make children creates a child halving
	 * parents energy(parent round up, child rounds down)
	 * 
	 * @param offspring,
	 *            the child of the Critter (same class type)
	 * @param direction,
	 *            the direction the child will move after being born add child
	 *            to a list of babies
	 */
	...
	/**
	 * first executes each critters time step in the population, subtracting
	 * necessary energy next removes any critters that have died from moving
	 * then resolves the conflicts for critters in the same position adds babies
	 * to real world clears babies list clears runaway list adds the necessary
	 * amount of Algae
	 * 
	 * @throws InvalidCritterException
	 */
	...
	/**
	 * Prints the border specified in Params.java A matrix is used to keep track
	 * of the positions of critters and blank space checks for white space
	 * first, else prints critter to String character
	 */
	...
	/**
	 * this method is called from worldTimeStep it resolves all conflicts
	 * between critters by calling fight in the positions with overlapping
	 * critters
	 */
